...
public interface IProcessDefinitionService {
     ...
     * @
     */
    ProcessInstance newProcessInstance(LoginUser user, String id, Map<String, Object> variables)
    ;
     ...
     * @
     */
    boolean assignmentTask(BizInfo bean, String taskID, LoginUser user, String toAssignment,
     ...
     * @
     */
    List<String[]> getNextTaskInfo(BizInfo bean);
     ...
     */
    String[] getNextTaskInfo(String nextTaskId, Map<String, Object> params);
